  ...
  return (
    <div
      ...
      style={{
        ...
        overflow: "hidden",
        boxShadow: hovered
          ? "0 24px 64px rgba(15,45,107,0.18)"
          : "0 6px 32px rgba(15,45,107,0.09)",
        transform: visible
          ? hovered
            ? "translateY(-6px)"
            : "translateY(0)"
...
export default function ProgramsSection() {
  ...
  useEffect(() => {
    fetch(`${API_URL}/api/programs`)
      .then((r) => r.json())
      .then((data: Program[]) =>
        setPrograms(data.filter((p) => p.status === "aktif")),
      )
      .catch(() => {});
  }, []);
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            {t.programs.title}{" "}
            <span className="title-gradient">{t.programs.titleGradient}</span>
          </h2>
          <p
            style={{
