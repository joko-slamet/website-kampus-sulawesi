...
const contactMeta = [
  ...
  },
  {
    ...
    labelKey: "labelFacebook" as const,
  ...
  },
  {
    ...
    labelKey: "labelInstagram" as const,
  ...
  },
  {
    ...
    labelKey: "labelWebsite" as const,
    getHref: () => "https://stiaahmakassar.ac.id/",
  ...
  return (
    <a
      ...
      style={{
        ...
        boxShadow: hovered
          ? `0 8px 24px ${item.bg}`
          : "0 2px 12px rgba(15,45,107,0.05)",
        transform: visible
          ? hovered
            ? "translateY(-3px)"
            : "translateY(0)"
      ...
      <div style={{ minWidth: 0 }}>
        ...
        <div
          style={{
            fontSize: "0.9rem",
            fontWeight: 700,
            color: hovered ? item.color : "var(--text-heading)",
    ...
    >
      ...
      >
        ...
        >
          ...
          >
            {c.heading}{" "}
            <span className="title-gradient">{c.headingGradient}</span>
          </h2>
          <p
            style={{
