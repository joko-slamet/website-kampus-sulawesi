...
const contacts = [
  ...
  },
  {
    ...
    label: 'Email',
    value: 'stiaabdulharis14@gmail.com',
    href: 'mailto:stiaabdulharis14@gmail.com',
    color: '#ea4335',
  ...
  },
  {
    ...
    label: 'Facebook',
    value: 'Stia Abdul Haris Makassar',
  ...
  },
  {
    ...
    label: 'Website',
    value: 'stiaabdulharis.ac.id',
    href: 'https://stiaabdulharis.ac.id/',
    color: '#0f2d6b',
...
function ContactCard({ item, index, visible }: { item: typeof contacts[0]; index: number; visible: boolean }) {
  ...
  return (
    <section id="kontak" ref={ref} style={{ padding: '6rem 0', background: 'white' }}>
      <div style={{ maxWidth: '1280px', margin: '0 auto', padding: '0 1.5rem' }}>
        ...
        {/* Contact cards — 3 cols on desktop */}
        <div style={{
          display: 'grid',
