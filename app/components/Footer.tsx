      ...
      >
        ...
        >
          ...
          <div>
            ...
            >
              {[t.footer.programLink1, t.footer.programLink2].map(
                (label, i) => (
                  <li key={label}>
                    <a
                      href={programHrefs[i]}
        ...
        >
          ...
          >
            {[
              ...
              {
                icon: "📍",
                label: "Jl. Gunung Bawakaraeng No. 72, Makassar (Kampus 2)",
              },
