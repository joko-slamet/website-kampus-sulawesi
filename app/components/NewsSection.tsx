...
function ImagePlaceholder({ type, category }: { type: 'news' | 'announcement'; category: string }) {
  ...
  return (
    <div style={{
      ...
      <span style={{ fontSize: '0.7rem', fontWeight: 600, color: color, textTransform: 'uppercase', letterSpacing: '0.08em' }}>
        {category}
      </span>
    </div>
  );
              ...
              >
                ...
                <div style={{ height: '220px', position: 'relative', overflow: 'hidden' }}>
                  {featured.image ? (
                    ...
                    <ImagePlaceholder type={featured.type} category={featured.category} />
                  )}
                  {/* Overlay badge */}
                ...
                <a key={item.id} href={`/news/${item.id}`} style={{ textDecoration: 'none' }}>
                  <div
                    style={{
                      ...
                      background: item.pinned ? 'linear-gradient(135deg, #fffbeb 0%, white 100%)' : '#f8fafc',
                    ...
                    onMouseEnter={e => {
                      ...
                      el.style.borderColor = item.pinned ? '#fde68a' : 'rgba(15,45,107,0.2)';
                  ...
                  >
                    ...
                    <div style={{
                      ...
                      {item.image ? (
                        ...
                        <div style={{
                          width: '100%', height: '100%',
                          background: item.type === 'announcement' ? '#fef3c7' : getCategoryColor(item.category) + '18',
                          display: 'flex', alignItems: 'center', justifyContent: 'center',
                          fontSize: '1.4rem',
                        }}>
                      ...
                      {item.pinned && (
                        <div style={{ position: 'absolute', top: '2px', right: '2px', fontSize: '0.65rem' }}>📌</div>
                      )}
                    </div>
