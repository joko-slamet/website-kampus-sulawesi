  ...
  return (
    ...
    >
      ...
      <div style={{
        ...
        background: 'radial-gradient(circle, rgba(26,74,173,0.2) 0%, transparent 70%)',
        borderRadius: '50%', zIndex: 1, pointerEvents: 'none',
      }} />
      ...
      <div style={{
        ...
        <div style={{ maxWidth: '760px' }}>
          ...
          >
            ...
            <span style={{ color: '#fbbf24', fontWeight: 600, fontSize: '0.8rem', letterSpacing: '0.06em' }}>
          ...
          <p style={{
            ...
            STIMIK Nusantara Sulawesi — kampus unggulan yang telah melahirkan
            lebih dari <strong style={{ color: 'white' }}>12.000 alumni</strong> profesional di seluruh Indonesia.
            Kuliah berkualitas, dosen berpengalaman, karier terjamin.
          </p>
          ...
          <div style={{
            ...
            <a
              href="#daftar"
              id="hero-cta-primary"
              onClick={(e) => { e.preventDefault(); handleScroll('daftar'); }}
              style={{
                display: 'inline-flex', alignItems: 'center', gap: '0.5rem',
                padding: '0.9rem 2rem',
              ...
              onMouseEnter={e => {
                ...
                (e.currentTarget as HTMLAnchorElement).style.boxShadow = '0 14px 40px rgba(245,166,35,0.55)';
              }}
              onMouseLeave={e => {
            ...
            <a
              ...
              onClick={(e) => { e.preventDefault(); handleScroll('program'); }}
              style={{
                display: 'inline-flex', alignItems: 'center', gap: '0.5rem',
                padding: '0.9rem 2rem',
          ...
          {/* Trust signals */}
          <div style={{
            display: 'flex', alignItems: 'center', gap: '1rem', marginTop: '2rem',
            opacity: visible ? 1 : 0,
            ...
            <div style={{ display: 'flex' }}>
              {[1, 2, 3, 4].map((i) => (
                <div key={i} style={{
                  ...
                  background: `hsl(${220 + i * 15}, 60%, ${50 + i * 5}%)`,
            ...
            <p style={{ color: 'rgba(255,255,255,0.8)', fontSize: '0.875rem' }}>
              <strong style={{ color: 'white' }}>5.200+</strong> mahasiswa aktif mempercayai kami
            </p>
          </div>
        </div>
