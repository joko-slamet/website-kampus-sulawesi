...
const TYPE_OPTIONS = [
  {
    ...
    label: "Berita",
    icon: "📰",
    desc: "Informasi & liputan kegiatan",
  },
  {
    value: "announcement",
    label: "Pengumuman",
    icon: "📢",
    desc: "Dapat disematkan di halaman utama",
  },
] as const;
...
export default function NewsEditor({ initial, onBack, onSave }: Props) {
  ...
  const handleGenerate = async () => {
    ...
    try {
      ...
      setGenerateError(
        e instanceof Error ? e.message : "Gagal generate konten",
      );
    } finally {
      setGenerating(false);
    }
      ...
      >
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
              ...
              {TYPE_OPTIONS.map((opt) => {
                ...
                return (
                  <button
                    ...
                    onClick={() => {
                      set("type", opt.value);
                      if (opt.value === "news") set("pinned", false);
                    }}
                    style={{
                      display: "flex",
                      alignItems: "center",
          ...
          <div
            style={{
              background: "var(--bg-card)",
              border: `1px solid ${generating ? "#a5b4fc" : "#e2e8f0"}`,
              borderRadius: "14px",
              overflow: "hidden",
              position: "relative",
          ...
          >
            ...
            >
                  ...
                  {group.map((btn) => (
                    <button
                      ...
                      style={{
                        ...
                        cursor: "pointer",
                        color: "var(--text-heading)",
                        fontSize: btn.mono ? "0.85rem" : "0.75rem",
                        fontWeight: 700,
                        display: "flex",
                        alignItems: "center",
              ...
              >
                ...
                <button
                  ...
                  title={
                    !form.title.trim()
                      ? "Tulis judul terlebih dahulu"
                      : "Generate konten dengan AI berdasarkan judul"
                  }
                  style={{
                    display: "inline-flex",
                    alignItems: "center",
                    ...
                    border: "none",
                    cursor:
                      !form.title.trim() || generating || saving
                        ? "not-allowed"
                        : "pointer",
                    background:
                      !form.title.trim() || generating || saving
                    ...
                    transition: "all 0.2s",
                    opacity:
                      !form.title.trim() || generating || saving ? 0.6 : 1,
                    boxShadow:
                      !form.title.trim() || generating || saving
                        ? "none"
            ...
            {generating && (
              ...
              >
                ...
                <p style={{ fontSize: "0.75rem", color: "#818cf8" }}>
                  Berdasarkan judul yang kamu tulis
                </p>
              </div>
            )}
          </div>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
                ...
                <img
                  src={
                    ...
                    form.image.startsWith("blob:")
                      ? form.image
                      : `${process.env.NEXT_PUBLIC_API_URL ?? "https://stiaahmakassar.ac.id"}${form.image}`
                  }
                  alt="preview"
                  style={{
                    width: "100%",
              ...
              >
                ...
                <button
                  ...
                  style={{
                    ...
                    cursor: "pointer",
                    padding: "2px",
                    background: form.pinned ? "#f59e0b" : "#e2e8f0",
                    transition: "background 0.2s",
                    flexShrink: 0,
                    display: "flex",
                    alignItems: "center",
                ...
                {(
                  ...
                  <button
                    ...
                    style={{
                      ...
                      border: "1.5px solid",
                      borderColor:
                        form.published === opt.val ? opt.border : "#e2e8f0",
          ...
          >
            ...
            >
              {[
                "Pengumuman penting bisa disematkan agar tampil paling atas",
                "Gambar disarankan rasio 16:9",
