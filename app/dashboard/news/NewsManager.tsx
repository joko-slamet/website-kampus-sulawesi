...
export default function NewsManager() {
  ...
  const handleEdit = async (item: NewsItem) => {
    ...
    try {
      ...
      setView({
        mode: "editor",
        item: { ...item, content: full.content ?? "", tag: full.tag ?? "" },
      });
    } catch {
    ...
    <div>
      ...
      >
        ...
        <select
          value={sort}
          onChange={(e) => {
            setSort(e.target.value as "terbaru" | "trending");
            setPage(1);
          }}
          style={{
            height: "36px",
      ...
      {!loading && items.length === 0 && (
        ...
        >
          ...
          >
            Mulai dengan menulis berita atau pengumuman.
          </p>
          <button
            onClick={() => setView({ mode: "editor" })}
            style={{
        ...
        >
          <div
            style={{
              display: "grid",
              gridTemplateColumns:
                "minmax(0,2.5fr) 115px minmax(0,1fr) 100px 85px 55px 165px",
            ...
            <div
              ...
              style={{
                ...
                background: item.pinned
                  ? "linear-gradient(90deg, #fffbeb 0%, var(--bg-card) 100%)"
                  : "var(--bg-card)",
              }}
      ...
      {(confirmDelete || modalClosing) && (
        <div
          style={{
            ...
            justifyContent: "center",
            padding: "1rem",
            animation: `${modalClosing ? "backdrop-out" : "backdrop-in"} 0.2s ease both`,
          }}
          onClick={(e) => {
        ...
        >
          <div
            style={{
              ...
              overflow: "hidden",
              animation: `${modalClosing ? "modal-out" : "modal-in"} 0.2s ease both`,
            }}
          >
